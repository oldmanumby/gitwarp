...
- **Interactive Tools**: 
  - *Deep Linker*: Dynamically targets specific lines of code (e.g., L10-L20) and handles raw text toggle (`?plain=1`).
  - *Time Machine Compare*: Easily generates comparison diffs between branches, tags, or specific timeframes (e.g., `1.week.ago`).
  - *Commit Feed*: Filter commit history by author, branch, and specific file paths.
